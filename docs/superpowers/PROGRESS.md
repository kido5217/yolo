...
S4 done (8/8 child beads closed, slice gate green — the user-run TTY
smoke is on-demand, pending). Next: S5 detail pass (prompt completion
+ attention — slice bead `yolo-oae.6`).
